...
import { apiSignupEmail } from "@/services/api";
              ...
              <div className="space-y-6 mb-10">
                <div className="space-y-2">
                  <p className="text-4xl md:text-5xl font-bold leading-tight">
                    Start Your
                    <br />
                    <span className="bg-gradient-to-r from-white to-white/80 bg-clip-text text-transparent">Success Story</span>
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  <p className="text-lg md:text-xl text-white/90 leading-relaxed">
                    ...
                    <br />
                    <span className="font-semibold">Your journey begins today!</span>
                  </p>
